  ...
  const features = [
    {
      ...
      description:
        "Captures 99.97% of dust, allergens, and viruses. Breathe pure, mountain-fresh air at home.",
      icon: (
    ...
    },
    {
      ...
      description:
        "Sensors detect temperature and air quality changes, adjusting airflow automatically.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
    ...
    },
    {
      title: "Whisper Quiet",
      description:
        "Acoustically engineered to operate at less than 20dB, perfect for uninterrupted sleep.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
