...
export const SupportAssistant: React.FC = () => {
  ...
  return (
    <div
      className={`tfx-support-assistant-root fixed inset-x-0 bottom-0 sm:bottom-8 sm:right-5 sm:left-auto z-[95] pointer-events-none ${
        open ? 'tfx-support-assistant-root-open' : ''
      } ${isProductPage ? 'tfx-support-assistant-root-product' : ''}`}
    >
      {open ? (
        <>
          <div
                        ...
                        >
                          ...
                          <div className="flex gap-2 mt-auto pt-3">
                            ...
                            <button
                              ...
                              onClick={() => {
                                window.location.href = `/product/${getProductSlug(product)}`;
                              }}
                            >
                              View
                            </button>
