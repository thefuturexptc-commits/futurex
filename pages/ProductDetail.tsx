...
export const ProductDetail: React.FC = () => {
  ...
  const showFanFeatureBanner = toProductSlug(product?.name || '') === 'the-future-x-tp02-3-in-1-bladeless-tower-fan-air-cooler-plasma-purifier-led-light-for-home-office-use';
  ...
  return (
    <div className="product-detail-dark min-h-screen bg-dark-bg text-white">
            ...
            <div className="mb-6 overflow-hidden rounded-2xl border border-white/10 bg-black">
              <div className="flex items-center justify-between gap-3 border-b border-white/10 bg-white/[0.04] px-4 py-3">
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium text-white">Cooling, control, and support at a glance</p>
                </div>
              </div>
              <img
                src="/images/fan-banner-tp-3-in-1.webp"
      ...
      ${!isDescriptionExpanded ? 'max-h-[112px] sm:max-h-[132px]' : 'max-h-[1000px]'}`}
                    >
                      <div
                        className="[&_p]:mb-3 
      ...
      [&_strong]:text-white"
                    ...
                    {!isDescriptionExpanded && (
                      <div className="absolute bottom-0 left-0 w-full h-14 bg-gradient-to-t from-dark-bg via-dark-bg/80 to-transparent pointer-events-none" />
                    )}
                  </div>
                  ...
                  <button
                    ...
                    className="mt-3 inline-flex items-center rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-primary-300 transition-colors hover:bg-white/10 hover:text-primary-200"
                  >
