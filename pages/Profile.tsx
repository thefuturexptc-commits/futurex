                    ...
                    {orders.map(order => (
                        ...
                        <div className="border-t border-gray-100 dark:border-white/5 pt-4">
                            ...
                            <div className="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-gray-100 pt-4 dark:border-white/10">
                              ...
                              {Boolean(order.trackingId?.trim()) && (
                                <Link
                                  to={`/track-order?orderId=${encodeURIComponent(order.id)}`}
                                  className="inline-flex items-center justify-center rounded-full bg-primary-600 px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-primary-700"
                                >
                                  Track Order
                                </Link>
                              )}
