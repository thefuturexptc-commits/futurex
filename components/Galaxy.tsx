...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      program.uniforms.uResolution.value = new Color(gl.canvas.width, gl.canvas.height, gl.canvas.width / Math.max(1, gl.canvas.height));
    };
  ...
  if (reducedMotion) {
    return <div className="galaxy-container bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.18),transparent_45%)]" {...rest} />;
  }
