...
import bandHero from '../assets/images/tfx-band-sleep-hero.png';
...
const bandFaqs = [
  {
    q: 'How many smart band products show in the catalog?',
    a: 'The catalog is connected to inventory and shows products categorized as Smart Bands.',
  },
  {
    q: 'Does the band need a screen?',
    a: 'No. TFX bands are designed to stay quiet on the wrist while the app shows summaries, trends, and wellness insights.',
  },
  {
    q: 'Can I use it for sleep tracking?',
    a: 'Yes. The lightweight form is intended for overnight wear, recovery tracking, and daily health trend review.',
  },
];
...
const CheckIcon: React.FC = () => (
  <svg className="h-4 w-4 shrink-0 text-[#18b8b2]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path fillRule="evenodd" d="M16.704 5.29a1 1 0 0 1 .006 1.414l-7.25 7.32a1 1 0 0 1-1.42 0l-3.25-3.28a1 1 0 1 1 1.42-1.408l2.54 2.563 6.54-6.603a1 1 0 0 1 1.414-.006Z" clipRule="evenodd" />
  </svg>
);
...
export const SmartBands: React.FC = () => {
  ...
  const featuredBandHref = catalogProducts[0] ? `/product/${toProductSlug(catalogProducts[0].name)}` : '/smart-bands';
  ...
  return (
    <div className="smart-bands-page relative min-h-screen bg-white text-slate-950">
      <section
        className="smart-bands-fixed-hero relative z-0 min-h-[680px] w-full overflow-hidden bg-slate-950 text-white sm:min-h-[calc(100svh-64px)] lg:min-h-[calc(100svh-80px)]"
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex min-h-[640px] max-w-7xl flex-col justify-start px-4 pb-14 pt-20 sm:min-h-[calc(100svh-64px)] sm:justify-center sm:px-8 sm:pb-14 sm:pt-24 lg:min-h-[calc(100svh-80px)] lg:px-10">
          <div
          ...
          >
            <h1 className="max-w-[340px] font-display text-[1.7rem] font-black leading-[1.12] tracking-normal text-white drop-shadow-[0_2px_18px_rgba(0,0,0,0.55)] sm:max-w-none sm:text-5xl lg:text-6xl">
              The Future of <span className="text-[#23d4ca]">Smart Bands</span> is Invisible
            </h1>
            <p className="mt-2 max-w-[340px] text-[13px] font-extrabold leading-5 text-white drop-shadow-[0_2px_14px_rgba(0,0,0,0.55)] sm:mt-5 sm:max-w-none sm:text-xl">
              Powered by AI, Worn Without a Screen
            </p>
            <p className="mt-3 max-w-[340px] text-[15px] font-medium leading-[1.48] text-white/95 drop-shadow-[0_2px_14px_rgba(0,0,0,0.55)] sm:mt-4 sm:max-w-2xl sm:text-lg sm:leading-8">
              We removed the screen to reinvent the experience. Our AI continuously analyzes your data, not just to show you numbers, but to predict, advise, and proactively manage your health.
            </p>
