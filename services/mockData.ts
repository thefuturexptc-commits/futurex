...
import smartRingProductImage from '../assets/images/smartrings-hero.png';
...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    inStock: true,
    colors: [
      { name: 'Black', hex: '#111827', images: ['https://picsum.photos/id/1/800/800', 'https://picsum.photos/id/2/800/800'], stock: 30, reservedStock: 0, sold: 0 },
      { name: 'Blue', hex: '#2563eb', images: ['https://picsum.photos/id/2/800/800', 'https://picsum.photos/id/1/800/800'], stock: 20, reservedStock: 0, sold: 0 }
    ],
    weight: '24g',
    isFeatured: true,
    isBestSeller: true,
  ...
  },
  {
    ...
    images: [smartRingProductImage, smartRingProductImage],
    ...
    inStock: true,
    colors: [
      { name: 'Black', hex: '#111827', images: [smartRingProductImage], stock: 8, reservedStock: 0, sold: 0 },
      { name: 'Silver', hex: '#9ca3af', images: [smartRingProductImage], stock: 7, reservedStock: 0, sold: 0 },
      { name: 'Gold', hex: '#d4af37', images: [smartRingProductImage], stock: 5, reservedStock: 0, sold: 0 }
    ],
    weight: '8g',
    isFeatured: true,
    rating: 4.9,
  ...
  },
  {
    ...
    inStock: true,
    colors: [
      { name: 'White', hex: '#f3f4f6', images: ['https://picsum.photos/id/5/800/800'], stock: 15, reservedStock: 0, sold: 0 }
    ],
    rating: 4.7,
    reviewCount: 320
  },
  {
    ...
    inStock: true,
    colors: [
      { name: 'White', hex: '#f3f4f6', images: ['https://picsum.photos/id/6/800/800'], stock: 100, reservedStock: 0, sold: 0 }
    ],
    rating: 4.6,
    reviewCount: 410
  },
  {
    ...
    inStock: true,
    colors: [
      { name: 'Black', hex: '#111827', images: ['https://picsum.photos/id/7/800/800'], stock: 120, reservedStock: 0, sold: 0 },
      { name: 'Pink', hex: '#ec4899', images: ['https://picsum.photos/id/7/800/800'], stock: 45, reservedStock: 0, sold: 0 },
      { name: 'Green', hex: '#10b981', images: ['https://picsum.photos/id/7/800/800'], stock: 35, reservedStock: 0, sold: 0 }
    ],
    weight: '18g',
    isBestSeller: true,
    rating: 4.5,
