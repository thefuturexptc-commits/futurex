...
export const ProductImageCarousel: React.FC<ProductImageCarouselProps> = React.memo(
  ({ images, videoUrl, alt, selectedIndex: externalIndex, onSelectIndex }) => {
    ...
    return (
      <div className="w-full">
        <div className="group relative overflow-hidden bg-white" ref={emblaRef}>
          <div className="flex touch-pan-y">
            {mediaItems.map((item, idx) => (
              <div
                ...
                className="relative min-w-0 flex-[0_0_100%] aspect-[4/3] cursor-zoom-in overflow-hidden border-0 bg-transparent p-0 sm:aspect-square"
              ...
              >
                {item.type === 'video' ? (
                  ...
                  <img
                    src={item.src}
                    alt={alt}
                    className="h-full w-full transform-gpu object-contain transition-transform duration-75 ease-out will-change-transform group-hover:scale-[1.025]"
                    draggable={false}
                  ...
                  >
                    <div className="grid grid-cols-[2.25rem_minmax(0,1fr)_2.25rem] items-center gap-2">
                      ...
                      <input
                        ...
                        className="h-8 w-full cursor-pointer accent-[#22b8b4]"
                      />
                      <button
                        type="button"
                        onClick={() => updateZoomScale(Number((zoomScale + 0.2).toFixed(1)))}
