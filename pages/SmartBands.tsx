  ...
  const features = [
    {
      ...
      description:
        "Military-grade sensors track heart rate, SpO2, and stress levels with 99.8% clinical accuracy.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Proprietary solar-glass technology extends battery life up to 14 days on a single charge.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      title: "Hyper-Durable",
      description:
        "Forged carbon fiber casing ensures resistance against impact, water (50m), and dust.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
