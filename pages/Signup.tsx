...
import { isPhoneRegistered, registerUser, resetPhoneOtpFlow, sendPhoneOtp, verifyPhoneOtp } from '../services/backend';
...
export const Signup: React.FC = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      setError(err?.message || 'Failed to send OTP. Check phone auth setup and try again.');
    } finally {
      setOtpSending(false);
    }
  };
          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <Button type="button" size="sm" variant="outline" onClick={handleVerifyOtp} disabled={otpVerifying || !otpSent || loading}>
