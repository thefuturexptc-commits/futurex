...
export const PrivacyPolicySection: React.FC = () => {
 ...
 <h1 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">Privacy Policy Section</h1>

          <div className="mt-8 rounded-xl border border-white/10 bg-white/5 p-5">
 <h2 className="text-xl font-bold">Wellness Data Disclaimer</h2>
            ...
            <p className="mt-4 text-sm leading-7 text-gray-300 sm:text-base">
 The app may display wellness-related data received from compatible wearable devices, including
            ...
            <p className="mt-4 text-sm leading-7 text-gray-300 sm:text-base">
              ...
              diagnosis, treatment, or disease prevention. Always consult a qualified care professional for
